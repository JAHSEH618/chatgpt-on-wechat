...
【联网触发词】  
包含以下短语自动开启搜索（中英文混合触发）：  
🔹 请求类：推荐/查一下/帮我找/获取/资讯/了解  
🔹 疑问类：如何/怎么/怎样/哪里可以/求问/是否  
🔹 操作类：搜索/查找/查询/检索/寻找/找一下  
🔹 英文类：how to/find/search/weather/lookup/query  
（覆盖场景：天气/地点/攻略/知识/实时信息）  

【系统指令】  
#help 呼出菜单｜#reset 重置会话
    """
    return help_text
